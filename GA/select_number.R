#data <- rnorm(runif(1000000,0,1), dim=c(100,100,100)); 
...
selected_data <- array(runif(0,1), dim=c(100,1));

repeat{
  first_level_random <- sample(1:100, 1)
  second_level_random <- sample(1:100, 1)
  third_level_random <- sample(1:100, 1)
